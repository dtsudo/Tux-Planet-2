...
let Enemy_Bullet_Fireball_Spiral = ((function () {
	...
	let getEnemy = function (
		...
		yInitialMibi: number,
		angleScaled: number,
		radiusInMibipixels: number,
		angularSpeedInAngleScaledPerFrame: number,
		radiusSpeedInMibipixelsPerFrame: number,
	...
	return {
		getEnemy: function ({
			...
			yInitialMibi,
			angleScaled,
			angularSpeedInAngleScaledPerFrame,
			radiusSpeedInMibipixelsPerFrame,
			isRotatingClockwise,
			enemyId
		}: {
			xInitialMibi: number,
