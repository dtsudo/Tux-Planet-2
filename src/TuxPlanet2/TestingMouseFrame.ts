...
let TestingMouseFrame: { getFrame: (globalState: GlobalState, sessionState: SessionState) => IFrame } = {} as any;

TestingMouseFrame.getFrame = function (globalState: GlobalState, sessionState: SessionState): IFrame {
