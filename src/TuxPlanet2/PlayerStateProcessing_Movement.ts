...
let PlayerStateProcessing_Movement: { processPlayerMovement: (gameState: GameState, frameInput: FrameInput, soundOutput: ISoundOutput) => void } = ((function () {

	let collidesWithTilemap = function (xMibi: number, yMibi: number, tilemap: Tilemap): boolean {
	...
	let processPlayerMovementHelper = function (gameState: GameState, frameInput: FrameInput): { updatedXMibi: number, updatedYMibi: number, collidedWithTilemap: boolean } {
	...
	let processPlayerMovement = function (gameState: GameState, frameInput: FrameInput, soundOutput: ISoundOutput): void {
		let tilemap = gameState.tilemap;
