...
let EnemyCollision = {
	processCollisionBetweenPlayerAndEnemies: function (gameState: GameState): void {
	...
	processCollisionBetweenPlayerBulletsAndEnemies: function (gameState: GameState): void {
