...
let Enemy_Bullet_Noone: { getEnemy: (xMibi: number, yMibi: number, directionScaled: number, rotatesClockwise: boolean, displayAngleScaled: number, difficulty: Difficulty, enemyId: number) => IEnemy } = {} as any;
...
((function () {
	...
	Enemy_Bullet_Noone.getEnemy = function (xMibi: number, yMibi: number, directionScaled: number, rotatesClockwise: boolean, displayAngleScaled: number, difficulty: Difficulty, enemyId: number): IEnemy {
