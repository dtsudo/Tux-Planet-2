...
let Enemy_Level1BossCutscene: { getEnemy: (enemyId: number) => IEnemy & Level1BossCutsceneEnemy } = {} as any;
...
((function () {
	...
	Enemy_Level1BossCutscene.getEnemy = function (enemyId: number): IEnemy & Level1BossCutsceneEnemy {
