...
((function () {
	let getEnemy = function (
		...
		let render = function (displayOutput: IDisplayOutput) {
			...
			displayOutput.drawImageRotatedClockwise(
				isFacingRight ? GameImage.BouncySnow : GameImage.BouncySnow_Mirrored,
				spriteNum * 16,
				0,
				16,
				16,
	...
	Enemy_Snowball.getEnemy = function ({ xInitialMibi, yInitialMibi, isFacingRight, difficulty, enemyId }: { xInitialMibi: number, yInitialMibi: number, isFacingRight: boolean, difficulty: Difficulty, enemyId: number }): IEnemy {

		let hp: number;

		switch (difficulty) {
			case Difficulty.Easy: hp = 36; break;
