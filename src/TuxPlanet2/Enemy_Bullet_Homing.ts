...
let Enemy_Bullet_Homing: { getEnemy: (xMibi: number, yMibi: number, initialAngleScaled: number, enemyId: number) => IEnemy } = {} as any;
...
((function () {
	...
	Enemy_Bullet_Homing.getEnemy = function (xMibi: number, yMibi: number, initialAngleScaled: number, enemyId: number): IEnemy {
