...
let Enemy_Bullet_Freezewave: { getEnemy: (xMibi: number, yMibi: number, playerState: PlayerState, difficulty: Difficulty, enemyId: number) => IEnemy } = {} as any;
...
((function () {
	...
	Enemy_Bullet_Freezewave.getEnemy = function (xMibi: number, yMibi: number, playerState: PlayerState, difficulty: Difficulty, enemyId: number): IEnemy {
