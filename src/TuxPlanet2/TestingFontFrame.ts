...
let TestingFontFrame: { getFrame: (globalState: GlobalState, sessionState: SessionState) => IFrame } = {} as any;

TestingFontFrame.getFrame = function (globalState: GlobalState, sessionState: SessionState): IFrame {
