...
let Enemy_Bullet_Fireball_Homing = ((function () {
	...
	let getEnemy = function (
		...
		targetPixelXMibi: number,
		targetPixelYMibi: number,

		targetPixelSpeedInMibipixelsPerFrame: number,

		targetPixelAngleScaled1: number,
		targetPixelAngleScaled2: number,
		targetPixelAngleScaled3: number | null,
		targetPixelAngleOffsetScaled3: number,

		switchToPhase2Cutoff: number,
		switchToPhase3Cutoff: number,

		speedInMibipixelsPerFrame: number,
		...
		let getSnapshot = function (thisObj: IEnemy) {
			return getEnemy(
				...
				targetPixelXMibi,
				targetPixelYMibi,
				targetPixelSpeedInMibipixelsPerFrame,
				targetPixelAngleScaled1,
				targetPixelAngleScaled2,
				targetPixelAngleScaled3,
				targetPixelAngleOffsetScaled3,
				switchToPhase2Cutoff,
				switchToPhase3Cutoff,
				speedInMibipixelsPerFrame,
				displayAngleScaled,
				frameCounter,
				screenWipeCountdown,
				enemyId);
	...
	return {
		getEnemy: function ({
			...
			return getEnemy(
				...
				switchToPhase3Cutoff,
				speedInMibipixelsPerFrame,
				-targetPixelAngleScaled1 - 90 * 128,
				0,
				null,
				enemyId);
		}
