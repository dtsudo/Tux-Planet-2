...
let SolidLayerUtil = ((function () {
	...
	let isValidSolidId = function (solidId: number | null): boolean {
	...
	let isValidSolidLayer = function (solidLayer: (number | null)[][]): boolean {
	...
	let isSolidCheck = function (
			xMibi: number,
			yMibi: number,
			solidId: number | null): boolean {
	...
	let isSolid = function (
			...
			solidLayer: (number | null)[][]): boolean {
		...
		let solidId: number | null = solidLayer[tileX][tileY];
